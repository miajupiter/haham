...
const xSmallMedia = window.matchMedia('(max-width: 599.99px)')
const smallMedia = window.matchMedia('(min-width: 600px) and (max-width: 767.99px)')
const mediumMedia = window.matchMedia('(min-width: 768px) and (max-width: 959.99px)')
const largeMedia = window.matchMedia('(min-width: 960px)');
